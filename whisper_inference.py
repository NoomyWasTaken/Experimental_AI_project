...
if __name__ == "__main__":
    print("Model test")
    asr = WhisperInference("facebook/wav2vec2-base-100h")  # Replace with the correct Whisper model name
    text = asr.file_to_text("../Audio_Speech_Actors_01-24/03-01-08-02-01-01-01.wav")  # Replace with the path to your audio file
    print(text)
